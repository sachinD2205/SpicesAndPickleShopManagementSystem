 ...
 * @author star
 */
public class PRListFrame extends javax.swing.JFrame {
    ...
    public PRListFrame() {
        ...
        db.applySearch(table1, cmbfield, txtsearch, "select * from PR");
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PRNo", "PRDate", "SuppNo", "SuppName", "SuppAddress", "PRAmt"
            }
        ) {
        ...
        btnprint1.setText("Print PR List");
        ...
        tabpanel.addTab("Purchase Returns List", jPanel2);

        jPanel1.setBackground(new java.awt.Color(250, 72, 37));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Purchase Returns List");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tabpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 614, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(i!=-1){            
            if(Messages.showConfirm("Delete selected PR?", "Confirm Delete")==0){
                String no=table1.getValueAt(i, 0)+"";
                db.execute("delete from PR where PRNo=?", no);
                db.fillTable(table1, "select * from PR");
            }
        }else{
    ...
    private void btnedit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnedit1ActionPerformed
        // Add New PR
        PREntrytFrame.parent=this;
        PREntrytFrame f=new PREntrytFrame();
        f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRListFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRListFrame().setVisible(true);
            }
        });
    }

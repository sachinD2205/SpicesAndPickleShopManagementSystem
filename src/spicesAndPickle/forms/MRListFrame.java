 ...
 * @author star
 */
public class MRListFrame extends javax.swing.JFrame {
    ...
    public MRListFrame() {
        ...
        db.applySearch(table1, cmbfield, txtsearch, "select * from MR");        
    }
    ...
    private void initComponents() {
        ...
        cmbfield.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MRNo", "MRDate", "InvoiceNo", "InvoiceDate", "SuppNo", "SuppName", "PONo" }));
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MRNo", "MRDate", "InvoiceNo", "InvoiceDate", "PONo", "SuppNo", "SuppName", "SuppAddress", "Transport", "InvAmt"
            }
        ) {
        ...
        btnprint1.setText("Print MR List");
        ...
        tabpanel.addTab("Material Receipt  List", jPanel2);

        jPanel1.setBackground(new java.awt.Color(250, 72, 37));

        jLabel3.setText("Material Entry Register");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tabpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 612, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(i!=-1){            
            if(Messages.showConfirm("Delete selected MR?", "Confirm Delete")==0){
    ...
    private void btnedit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnedit1ActionPerformed
        // Add New MR
        MREntrytFrame.parent=this;
        MREntrytFrame f=new MREntrytFrame();
        f.setVisible(true);
    ...
    private void btnprint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprint1ActionPerformed
        ...
        db.showReport("src/reports/MRListReport.jrxml",map);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MRListFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MRListFrame().setVisible(true);
            }
        });
    }

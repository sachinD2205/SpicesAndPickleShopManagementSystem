 ...
 * @author star
 */
public class MREntrytFrame extends javax.swing.JFrame {

    DBClass db=new DBClass();
    public static MRListFrame parent;
    /**
     * Creates new form NewJFrame8
     */
    public MREntrytFrame() {
        initComponents();
        ...
        db.fillCombo(cmbpo, "select * from PO", "PONo", "PONo");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Add New Material Receipt", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 12))); // NOI18N
        jPanel1.setForeground(new java.awt.Color(204, 0, 51));

        jLabel3.setText("MR Date");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtinvdate, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(12, 12, 12))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(461, 461, 461)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tabpanel.addTab("New MR", jPanel3);

        jPanel2.setBackground(new java.awt.Color(250, 72, 37));

        jLabel6.setText("Material Receipt Entry");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tabpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 652, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(txtdate.getText().trim().equals("")){
            Messages.showError("Material Receipt Date cannot be left empty..", "Input Error");
        ...
        if(txtinvdate.getText().trim().equals("")){
            Messages.showError("Invoice Date cannot be left empty..", "Input Error");
            txtinvdate.requestFocus();
            return;
        }
        String invdate=txtinvdate.getDate().format(DateTimeFormatter.ISO_DATE);
        ComboItem ci=(ComboItem) cmbpo.getSelectedItem();
        String pono=ci.returnField;        
        ci=(ComboItem) cmbsupplier.getSelectedItem();
        ...
        if(invno.equals("")){
            Messages.showError("Invoice No cannot be left empty..", "Input Error");
        ...
        //Master Record Entry
        db.execute("Insert into MR values (?,?,?,?,?,?,?,?,?,?)", mrno,mrdate,invno,invdate,pono,suppno,suppname,suppaddress,transport,invtotal);
        ...
        for(int i=0;i<tab1.getRowCount();i++){
            ...
            db.execute("Insert into MRItems values (?,?,?,?,?,?,?)", mrno,itemno,itemname,qty,unit,price,total);
        ...
        db.updateID("MRNo");
        txtmrno.setText(db.getID("MRNo"));
        db.fillTable(parent.table1, "select * from MR");
        Messages.showInfo("Material Entered Successfully..", "Success");                
    ...
    private void cmbpoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbpoItemStateChanged
        ...
        //System.out.println(ci);
        if(ci!=null){
            String suppno=ci.data.get("SuppNo")+"";
            ci=db.getItem(cmbsupplier, suppno);
            cmbsupplier.setSelectedItem(ci);        
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MREntrytFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MREntrytFrame().setVisible(true);
            }
        });
    }
